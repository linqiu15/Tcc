# ----------------------------------------------------------DD*----------------------------------------------------#
function potential_DnDsc(E,p, q; I=0, a=0, cl=:ss)
...
#     res += -4 * g^2 / fπ^2 / sqrt(16) * (pwa_tensor_deform(p, q, mπc^2 - q02^2; cl=cl) - a / 3 * pwa_contact(p, q, mπc^2 - q02^2; cl=cl)) * (I - 1 / 2) * 2
...
function potential_DcDsn(E,p, q; I=0, a=0, cl=:ss)
...
function potential_DDscross(E,p, q; I=0, a=0, cl=:ss)
...
#     res += 2 * g^2 / fπ^2 / sqrt(16) * (pwa_tensor_deform(p, q, mπn^2 - q02^2; cl=cl) - a / 3 * pwa_contact(p, q, mπn^2 - q02^2; cl=cl)) * (I - 1 / 2) * 2
