...
function potential_DnDsc(E, p, q; I=0, a=0, a1=0.0, cl=:ss, r=10.0)
    res = zero(ComplexF64)
...
function potential_DcDsn(E, p, q; I=0, a=0, a1=0.0, cl=:ss, r=10.0)
    res = zero(ComplexF64)
...
function potential_DDscross(E, p, q; I=0, a=0, a1=0.0, cl=:ss, r=10.0)
    res = zero(ComplexF64)
